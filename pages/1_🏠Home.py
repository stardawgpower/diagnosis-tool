...
def home():
    ...
    st.write("This tool lets you quickly analyse your data and gain insights to inform your decision-making. Simply upload your CSV file using the 'Browse files' button below to get started. Once your data is loaded, you can use the various features and tools to visualise and explore your data, including generating descriptive statistics, creating charts and graphs, finding influencing factors and more.") 
